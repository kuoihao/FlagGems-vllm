...
@pytest.mark.skipif(
    flaggems_vllm.vendor_name == "metax", reason="Issue #2843: RuntimeError"
)
@pytest.mark.skipif(
    flaggems_vllm.vendor_name == "hygon", reason="Issue #2844: RuntimeError"
)
...
def test_concat_and_cache_mla(
    ...
    with torch.device(device):
        ...
        with flaggems_vllm.use_gems():
            flaggems_vllm.concat_and_cache_mla(
