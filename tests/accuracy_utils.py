...
fp64_is_supported = flaggems_vllm.runtime.device.support_fp64
bf16_is_supported = flaggems_vllm.runtime.device.support_bf16
int64_is_supported = flaggems_vllm.runtime.device.support_int64


def TestForwardOnly():
    return flaggems_vllm.vendor_name in []
...
def gems_assert_equal(res, ref, equal_nan=False):
    res = to_cpu(res, ref)
    flaggems_vllm.testing.assert_equal(res, ref, equal_nan=equal_nan)
