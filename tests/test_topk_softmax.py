...
from flaggems_vllm import topk_softmax
...
@pytest.mark.skipif(
    flaggems_vllm.vendor_name == "metax", reason="Issue #2857: RuntimeError"
)
...
def test_topk_softmax(
    ...
    if flaggems_vllm.vendor_name == "mthreads" and index_dtype == torch.uint32:
