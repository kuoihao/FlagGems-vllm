...
def _vllm_outplace_fused_experts_wrapper(
    hidden_states,
    w1,
    w2,
    topk_weights,
...
def _gems_outplace_fused_experts_wrapper(
    hidden_states,
    w1,
    w2,
    topk_weights,
    ...
    return flaggems_vllm.outplace_fused_experts(
        hidden_states,
        w1,
        w2,
        topk_weights,
...
def test_outplace_fused_experts_gems_vs_vllm():
    """
    Benchmark FlagGems outplace_fused_experts vs vLLM out-of-place fused_experts_impl.
    """
